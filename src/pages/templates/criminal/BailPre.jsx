...
export default function BailPre() {
    ...
    return (
      <div style={bodyStyle}>
        ...
        <div style={{ fontSize: 20, lineHeight: 1.2, marginBottom: 10, textAlign: 'center' }}>
          ...
          {' '}ولد{' '}
          <PlaceholderSpan value={v.father_name} />
          {' '}قوم{' '}
          <PlaceholderSpan value={v.caste} />
          {' '}سکنه{' '}
          <PlaceholderSpan value={v.address} />
          <span style={{ display: 'block', fontSize: 18, marginTop: 4, textAlign: 'left' }}>----(سائل / ملزم)</span>
        </div>

        <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 20, lineHeight: 1.1, display: 'table', margin: '0 auto', padding: '0 10px' }}>
          <p>بنــــــــــام</p>
          <p>ســـــــــــرکار</p>
        </div>

        <div style={{ textAlign: 'center', margin: '15px 0' }}>
          <span style={{ fontSize: 20, fontWeight: 'bold', textDecoration: 'underline', display: 'inline' }}>
            مقدمہ نمبر <PlaceholderSpan value={v.case_no} />
            {' '}مورخہ <PlaceholderSpan value={v.case_date} />
            {' '}بجرم زیر دفعہ <PlaceholderSpan value={v.sections} />
            <br />
            تھانہ <PlaceholderSpan value={v.police_station} />
          </span>
        </div>

        <div style={{ textAlign: 'center', margin: '15px 0' }}>
          <p style={{ fontSize: 22, margin: 0, fontWeight: 'bold', textDecoration: 'underline' }}>درخواست ضمانت قبل از گرفتاری</p>
        </div>

        <div style={{ display: 'block', fontSize: 16, fontWeight: 'bold', marginTop: 20 }}>
        ...
        <p style={{ fontSize: 16, textAlign: 'center', margin: '20px auto 0', width: '45%', marginRight: '65%' }}>
          حالات بالا کے پیش نظر استدعا ہے کہ سائل کی درخواست ضمانت قبل از گرفتاری منظور فرمائی جائے۔
        </p>
        ...
        <div style={{ fontSize: 16, display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: 10 }}>
          <div style={{ textAlign: 'center', marginRight: '75%' }}>
            ...
            <p style={{ fontWeight: 'bold', fontSize: 19, textAlign: 'center', display: 'block' }}>عــــــــــرضـــــــــے</p>
            <p style={{ textAlign: 'center' }}>
              {v.accused_name ? `(سائل / ملزم) ---- ${v.accused_name}` : <PlaceholderSpan value="" />}
            </p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: 10, textAlign: 'center', marginRight: '75%' }}>
            ...
            <span style={{ fontWeight: 'bold', fontSize: 18, display: 'block' }}>
              <PlaceholderSpan value={v.lawyer_name} />
            </span>
            <span style={{ fontWeight: 'bold', fontSize: 18, display: 'block' }}>ایڈووکیٹ ہائیکورٹ</span>
            <span style={{ fontSize: 16, display: 'block' }}>
              <PlaceholderSpan value={v.lawyer_address} />
            </span>
          </div>
        </div>
      </div>
  ...
  return <UrduLegalTemplate slug="bail-pre" title="Create Pre-Arrest Bail Application" fields={fields} renderDocument={renderDocument} />;
}
