...
export default function AzadDarulAman() {
    ...
    return (
      <div style={rtlStyle}>
        ...
        <div style={{ textAlign: 'center', margin: '15px 0' }}>
          <p style={{ fontSize: 22, fontWeight: 'bold', textDecoration: 'underline' }}>درخواست رہائی از دارالامان</p>
        </div>
        <div style={{ fontSize: 16, marginBottom: 10 }}>
          <p>مسماۃ: <PlaceholderSpan value={v.victim_name} /></p>
        </div>
        ...
        <p style={{ fontSize: 16, textAlign: 'center', margin: '20px auto 0', width: '45%', marginRight: '65%' }}>
          حالات بالا کے پیش نظر استدعا ہے کہ مسماۃ کو دارالامان سے رہا کیا جائے۔
        </p>
  ...
  return <UrduLegalTemplate slug="azad-darul-aman" title="Create Release from Darul-Aman Application" fields={fields} renderDocument={renderDocument} />;
}
