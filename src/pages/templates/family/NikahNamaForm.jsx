...
export default function NikahNamaForm() {
  ...
  return (
    <div style={{ fontFamily: 'Times New Roman, serif', lineHeight: 1.6, background: '#f4f4f9', minHeight: '100vh' }}>
      <style>{`
        @media print {
      ...
      <div style={{ paddingTop: 80, paddingBottom: 40, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* Header card */}
        <div className="no-print" style={{ width: 900, background: '#ffffff', padding: 25, border: '2px solid #0d2a3a', borderRadius: 12, boxShadow: '0 5px 15px rgba(0,0,0,0.15)', marginBottom: 30 }}>
        ...
        {/* Form */}
        <div className="print-area" style={{ width: 900, background: '#fff', padding: 20, border: '1px solid #ccc', borderRadius: 8 }}>
